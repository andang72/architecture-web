...
public class JdbcSequencer implements Sequencer {
    ...
    private void getNextBlock(int count) {
        ...
        try {
            ...
            if( type == 0 )
            {
            	pstmt = con.prepareStatement(getBoundSql("ARCHITECTURE_FRAMEWORK.SELECT_SEQUENCER_BY_NAME").getSql());
            ...
            // update first.
            pstmt = con.prepareStatement(getBoundSql("ARCHITECTURE_FRAMEWORK.UPDATE_SEQUENCER").getSql());
